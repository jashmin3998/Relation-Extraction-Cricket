...
ann = "training_data.json"
train_file = 'rel_component/data/relations_training.spacy'
dev_file = 'rel_component/data/relations_dev.spacy'
test_file = 'rel_component/data/relations_test.spacy'
